...
from vilt.config_vilt_v2 import parser
from vilt.vilt_model_v2 import Vilt
...
runtime_conf {
    ...
    export_model = Vilt(export_args, label_dict, deploy=True)
