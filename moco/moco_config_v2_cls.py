...
parser.add_argument('--moco_resume', default='/mnt/bn/zc-model-nas-lq/model_result/checkpoints_top_v1/20230220_train_mocov3_pretrain_v2/last_checkpoint.pth.tar',
                    type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
