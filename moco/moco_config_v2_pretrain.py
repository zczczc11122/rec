...
# ========================= Audio Configs =========================
parser.add_argument('--audio-pretrian', type=str, default='../11200_iterations.pth')
...
parser.add_argument('--experiment_pref', type=str, default="20230220_train_mocov3_pretrain_v2")
