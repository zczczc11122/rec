...
#预训练时lr设为0.00003，warmup-type设为"None"
...
parser.add_argument('--idx2class_file_expression', type=str, help='expression label path',
                    default='./vocabulary/class_id_v2_expression.txt')
parser.add_argument('--idx2class_file_material', type=str, help='material label path',
                    default='./vocabulary/class_id_v2_material.txt')
parser.add_argument('--idx2class_file_person', type=str, help='person label path',
                    default='./vocabulary/class_id_v2_person.txt')
parser.add_argument('--idx2class_file_style', type=str, help='style label path',
                    default='./vocabulary/class_id_v2_style.txt')
parser.add_argument('--idx2class_file_topic', type=str, help='topic label path',
                    default='./vocabulary/class_id_v2_topical.txt')

# ========================= pretrain Configs =========================
parser.add_argument('--task', default="cls", type=str, help='eg: 【mlm,itm,mrfr|cls】 cls is alone choose')
...
# ========================= Fusion Configs =========================
parser.add_argument('--fusion-pretrain', type=str, default='/mnt/bn/zc-model-nas-lq/model_pretrain_weight/jx_vit_base_p32_384-830016f5.pth')
...
# ========================= Classifier Configs =========================
parser.add_argument('--classifier-type', type=str, default='hierarchicalClassifier',
                    choices=['hierarchicalClassifier', 'hierarchicalClassifier_simple'])
...
parser.add_argument('--batch-size-val', default=4, type=int, help='mini-batch size')
...
parser.add_argument('--warmup-type', default='WarmupAndReduceLROnPlateau', choices=['WarmupAndOrdered', 'WarmupAndReduceLROnPlateau', 'WarmupAndExponentialDecay', 'None'],
...
# ========================= Checkpoint Configs =========================
parser.add_argument('--resume', default='/mnt/bn/zc-model-nas-lq/model_result/checkpoints_top_v1/uniter_v2_20230209_train_pretrain_mlm_itm_mrfr/last_checkpoint.pth.tar',
